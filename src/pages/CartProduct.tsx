...
export const CartProduct = ({id, productName, imageURL, appliedPrice, selectedQuantity, onIncrement, onDecrement, onDelete}:CartProductProps) => {
    return (
        <div className="flex items-center gap-4 py-4 border-b border-gray-200/60 last:border-0">
            ...
            <div className="flex flex-col items-center justify-center pl-3 shrink-0 text-gray-400 opacity-70">
                ...
                <button onClick={() => onDelete(id)} className="text-[10px] text-center leading-tight">Swipe to<br/>delete</button>
            </div>
        </div>
    );
}